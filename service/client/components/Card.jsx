    ...
    <div >
      <div>
        <div className="shadow-md rounded-sm overflow-hidden item" style={{ width: '250px', height: '50vh' }}>
          <div className="relative" onClick={props.addOutfit}>
          ...
          <div className="p-4">
            ...
            <p className="text-gray-800 mb-2 font-medium">{element.description}</p>
            <div className="flex item-center justify-between mp-2">
              <h1 className="text-gray-600 font-italic text-xs">{element.default_price}</h1>
            </div>
            <Stars />
          </div>
        </div>
